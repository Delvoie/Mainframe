      ...
      *PROGRAM DESCRIPTION:
      * This is the master menu program that allows users to
      * select customer inquiry, maintenance, or order entry.
      ...
      *
       01 WS-CICS-CNSTS.
           05 WS-MEN-TRANSID-CNST           PIC X(04) VALUE 'UFE1'.
           05 WS-MEN-MAPSET-CNST            PIC X(08) VALUE 'MENSFE1 '.
           05 WS-MEN-MAP-CNST               PIC X(08) VALUE 'MENMFE1 '.
      *
       01 WS-FILE-CNSTS.
      ...
      *
       01 WS-PROGRAM-LIST-TABLE.
           ...
           05 WS-PROGRAM-LIST-CNSTS.
               10 WS-PROGRAM-1-CNST         PIC X(8) VALUE 'CMINQFE1'.
               10 WS-PROGRAM-2-CNST         PIC X(8) VALUE 'CMMNTFE1'.
               10 WS-PROGRAM-3-CNST         PIC X(8) VALUE 'ORDERFE1'.
