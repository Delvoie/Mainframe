      ...
      *PROGRAM DESCRIPTION:
      * This program provides customer inquiry functionality
      * for the CICS customer master file system.
      ...
      *
       01 WS-CICS-CNSTS.
           ...
           05 WS-INQ-TRANSID-CNST           PIC X(04) VALUE 'IFE1'.
           05 WS-INQ-MAPSET-CNST            PIC X(08) VALUE 'INQSFE1 '.
           05 WS-INQ-MAP-CNST               PIC X(08) VALUE 'INQMFE1 '.
      *
       01 WS-FILE-CNSTS.
