      ...
      *
       01 WS-CICS-CNSTS.
           ...
           05 WS-MNT-TRANSID-CNST           PIC X(04) VALUE 'VYYY'.
           05 WS-MNT-MAPSET-CNST            PIC X(07) VALUE 'MNTSYYY'.
           05 WS-MNT-MAP1-CNST              PIC X(07) VALUE 'MNT1YYY'.
           05 WS-MNT-MAP2-CNST              PIC X(07) VALUE 'MNT2YYY'.
      *
       01 WS-FILE-CNSTS.
