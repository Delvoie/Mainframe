      ...
      *
       01 WS-CICS-CNSTS.
           05 WS-MEN-TRANSID-CNST           PIC X(04) VALUE 'UYYY'.
           05 WS-MEN-MAPSET-CNST            PIC X(08) VALUE 'MENSYYY '.
           05 WS-MEN-MAP-CNST               PIC X(08) VALUE 'MENMYYY '.
      *
       01 WS-FILE-CNSTS.
           05 WS-CMF-FILE-NAME-CNST         PIC X(08) VALUE 'CMFYYY  '.
      *
       01 WS-FLAGS.
      ...
      *
       01 WS-PROGRAM-LIST-TABLE.
           ...
           05 WS-PROGRAM-LIST-CNSTS.
               10 WS-PROGRAM-1-CNST         PIC X(8) VALUE 'CMINQYYY'.
               10 WS-PROGRAM-2-CNST         PIC X(8) VALUE 'CMMNTYYY'.
               10 WS-PROGRAM-3-CNST         PIC X(8) VALUE 'ORDERYYY'.
