      ...
      *
       01 WS-CICS-CNSTS.
           ...
           05 WS-INQ-TRANSID-CNST           PIC X(04) VALUE 'IYYY'.
           05 WS-INQ-MAPSET-CNST            PIC X(08) VALUE 'INQSYYY '.
           05 WS-INQ-MAP-CNST               PIC X(08) VALUE 'INQMYYY '.
      *
       01 WS-FILE-CNSTS.
      ...
      *
               WHEN EIBAID = DFHPF3 OR DFHPF12
                   GO TO 9800-SEND-TERMINATION-MESSAGE
      *
