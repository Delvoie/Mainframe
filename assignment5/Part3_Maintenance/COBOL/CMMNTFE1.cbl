       ...
       DATE-WRITTEN. Nov 22 2025.
      *PROGRAM DESCRIPTION:
      * This program provides customer maintenance functionality
      * including add, change, and delete operations on the
      ...
      *
       01 WS-CICS-CNSTS.
           05 WS-MEN-PROGRAM-CNST           PIC X(08) VALUE 'UUMENFE1'.
           05 WS-MNT-TRANSID-CNST           PIC X(04) VALUE 'VFE1'.
           05 WS-MNT-MAPSET-CNST            PIC X(07) VALUE 'MNTSFE1'.
           05 WS-MNT-MAP1-CNST              PIC X(07) VALUE 'MNT1FE1'.
           05 WS-MNT-MAP2-CNST              PIC X(07) VALUE 'MNT2FE1'.
      *
       01 WS-FILE-CNSTS.
           05 WS-CMF-FILE-NAME-CNST         PIC X(08) VALUE 'CMFFE1  '.
      *
       01 WS-FLAGS.
      ...
      *
               WHEN EIBAID = DFHPF3
                   ...
                   MOVE ALL '='             TO WS-HA-EXEC-TEXT-T8
      *
      * ADD PERFORM TO CLOSE VSAM FILE BEFORE XCTL
      *
